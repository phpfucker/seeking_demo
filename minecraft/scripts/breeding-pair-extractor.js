...
class BreedingPairExtractor {
    ...
    async processBreedingPairs(inputData = null, maxDistance = this.defaultBreedingDistance) {
        ...
        // 結果の詳細出力（特性データはformatted_status_data.jsonに含まれている）
        ...
        uniquePairs.forEach((pair, index) => {
            ...
            console.log(`    Male: behavior=${pair.male.behavior || 'N/A'}, sociality=${pair.male.sociality || 'N/A'}, lifespan=${pair.male.lifespan || 'N/A'}`);
            console.log(`    Female: behavior=${pair.female.behavior || 'N/A'}, sociality=${pair.female.sociality || 'N/A'}, lifespan=${pair.female.lifespan || 'N/A'}`);
